...
public class PrayerTimeCalculator {
    ...
    private final double[] TimePortions;
    ...
    public  PrayerTimeCalculator(int day, int mnth, int yer, double latitude, double longitud, double timeZone, PrayerTimes.Mazhab defaultMazhab, PrayerTimes.Way defaultWay, int dst, Context applicationContext) {
        ...
        this.Lng = longitud;
        this.Tzone = timeZone;
        mazhab = defaultMazhab;
        way = defaultWay;
        this.SumTimeZone = dst;
        this.JDate = this.calculateJulianDate(this.Day, this.Month, this.Year);
